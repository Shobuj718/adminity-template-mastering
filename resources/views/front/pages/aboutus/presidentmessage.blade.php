...
@section('main-title','President Information')

@section('content-heading')
    <h2 style="text-align:center;color:blue">President Message</h2><br>
@endsection
...
@section('main-content')
    ...
    <div class="row">
    	<div class="col-md-12 col-sm-12 col-lg-12">
    		...
    		<h2 class="priName">President Name</h2>
    		<p class="priAddress">President,Saghata pilot high school</p><br>
