...
@section('main-title','Red Cresent Information ')
...
<h2 style="color:#D083CF"><center>Red Cresent Information   </center></h2><br>
<div class="table-responsive">
    <table id="example" class="table" style="width:100%">
        ...
        <tbody>
           <tr>
                <td>1</td>
                <td>Red Cresent Information</td>
                <td>Red Cresent information details</td>
                <td>12-18-18</td>
