...
@section('main-title','Volunteer Information ')
...
<h2 style="color:#D083CF"><center>Volunteer Information   </center></h2><br>
    ...
    <table id="example" class="table" style="width:100%">
        ...
        <tbody>
           <tr>
                <td>1</td>
                <td>Shobuj</td>
                <td>Volunteer information details</td>
