...
<div class="u-img">
<img src="{{ asset('admin') }}/files/assets/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
<img src="{{ asset('admin') }}/files/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
</div>
</div>
<div class="col">
...
<img src="{{ asset('admin') }}/files/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
...
<h6 class="text-muted f-w-400"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="39535c5740795e54585055175a5654">[email&#160;protected]</a></h6>
</div>
<div class="col-sm-6">
