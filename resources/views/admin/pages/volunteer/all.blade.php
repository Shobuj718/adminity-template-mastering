...
@section('page-title', 'All Volunteer Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Volunteer Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($volunteer as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/volunteer/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/volunteer/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
