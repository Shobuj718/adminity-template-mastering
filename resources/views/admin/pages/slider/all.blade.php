...
@section('page-title', 'Slider Image Information ')
...
<div class="card">
	<div class="card-header">
		<h2>Slider Image Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($slider as $data)
					<tr>
						...
						<td>
                            <a href="{{url('/slider/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/slider/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
