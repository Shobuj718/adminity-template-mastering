...
@section('page-title', 'All Event Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Event Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($importantlink as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/importanlink/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/importanlink/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
