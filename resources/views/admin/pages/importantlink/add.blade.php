...
@section('page-title', 'Add Important Link')
		...
		<div class="col-sm-12">
			...
			<div class="card">
				<div class="card-header">
					<h2 style="text-align:center">Add Important Link</h2>
				...
				<div class="card-block">
					<form  method="post"  action="{{url('/importanlink/store')}}" enctype="multipart/form-data">
					{{csrf_field()}}
						<div class="form-group {{ $errors->has('linkName') ? 'has-error' : '' }} row">
							<label class="col-sm-2 col-form-label">Link Name</label>
							<div class="col-sm-10">
								<input type="text" value="{{ old('linkName') }}" class="form-control" name="linkName" id="linkName" placeholder="Enter important link name   ">
						...
						<div class="form-group {{$errors->has('address') ? 'has-error' : '' }} row">
							...
							<div class="col-sm-10">
								<input type="text" value="{{ old('address') }}" class="form-control" name="address" id="address" placeholder="Enter  address  link ">
