...
@section('page-title', 'All Parent Guideline Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Parent Guideline Information</h2>
		...
		<div class="table-responsive dt-responsive">
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				<thead>
					<tr>
						<th>Sl.</th>
						<th>Parent Guideline</th>
						<th>Guideline Details</th>
						<th>Image</th>
						<th>Action</th>
					</tr>
				</thead>
				...
				@foreach($guideline as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/parentsGuideline/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/parentsGuideline/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
