...
<div class="card">
	<div class="card-header">
		<h2>President Message Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($president as $data)
					<tr>
						...
						<td>
							<a href="{{url('/president/show/'.$data->id)}}" class="btn hor-grd btn-grd-info">View</a>

                            <a href="{{url('/president/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/president/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
