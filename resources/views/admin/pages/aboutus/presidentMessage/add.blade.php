...
@section('page-title', 'Add President Message ')
		...
		<div class="col-sm-12">
			...
			<div class="card">
				<div class="card-header">
					<h2 style="text-align:center">Add President Message</h2>
				...
				<div class="card-block">
					<form  method="post"  action="{{url('/president/store')}}" enctype="multipart/form-data">
					{{csrf_field()}}
