...
@section('page-title', 'Vice Principal Message Information ')
...
<div class="card">
	<div class="card-header">
		<h2>Vice Principal Message Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($viceprincipal as $data)
					<tr>
						...
						<td>
                            <a href="{{url('/vicePrincipal/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/vicePrincipal/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
