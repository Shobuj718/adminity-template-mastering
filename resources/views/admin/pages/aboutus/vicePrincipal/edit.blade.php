...
@section('page-title',' Edit Principal Message Information')
		...
		<div class="col-sm-12">
			...
			<div class="card">
				<div class="card-header">
					<h2 style="text-align:center">Edit Principal  Message</h2>
				...
				<div class="card-block">
					<form  method="post"  action="{{url('/vicePrincipal/update/'.$viceprincipal->id)}}" enctype="multipart/form-data">
					{{csrf_field()}}
						<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }} row">
							<label class="col-sm-2 col-form-label">Principal Name</label>
							<div class="col-sm-10">
								<input type="text" value="{{ $viceprincipal->name }}" class="form-control" name="name" id="name" >
								@if($errors->has('name'))
						...
						<div class="form-group {{ $errors->has('mobile') ? 'has-error' : '' }} row">
							...
							<div class="col-sm-10">
								<input type="mobile" value="{{ $viceprincipal->mobile }}" class="form-control" id="mobile" name="mobile" >
						...
						<div class="form-group {{$errors->has('message') ? 'has-error' : '' }} row">
							...
							<div class="col-sm-10">
								<textarea rows="5" cols="5" name="message" class="form-control" placeholder="Default textarea">{{ $viceprincipal->message }}</textarea>
						...
						<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }} row">
							...
							<div class="col-sm-10">
								...
								<img class="img-responsive" src="{{url($viceprincipal->image ? $viceprincipal->image : '')}}" width="80px" height="80px" alt="No Image">
							</div>
