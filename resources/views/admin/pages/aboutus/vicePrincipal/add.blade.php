...
@section('page-title', 'Add Vice Principal Message ')
		...
		<div class="col-sm-12">
			...
			<div class="card">
				<div class="card-header">
					<h2 style="text-align:center">Add Vice Principal Message</h2>
				...
				<div class="card-block">
					<form  method="post"  action="{{url('/vicePrincipal/store')}}" enctype="multipart/form-data">
					{{csrf_field()}}
						<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }} row">
							<label class="col-sm-2 col-form-label">Vice Principal Name</label>
							<div class="col-sm-10">
