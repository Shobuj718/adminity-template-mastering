...
@section('page-title', 'Principal Message Information ')
...
<div class="card">
	<div class="card-header">
		<h2>Principal Message Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($principal as $data)
					<tr>
						...
						<td>
                            <a href="{{url('/principal/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/principal/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
