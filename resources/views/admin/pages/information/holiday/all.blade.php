...
@section('page-title', 'All Holiday List Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Holiday List Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($holiday as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/holiday/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/holiday/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
