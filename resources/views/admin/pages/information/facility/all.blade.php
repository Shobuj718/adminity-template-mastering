...
@section('page-title', 'All Facility List Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Facility List Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($facility as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/facility/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/facility/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
