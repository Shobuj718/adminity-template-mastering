...
@section('page-title', 'All Notice Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Notice</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($notice as $data)
					<tr>
						...
						<td>
                            <a href="{{url('/news/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/news/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
