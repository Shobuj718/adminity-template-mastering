...
@section('page-title', 'All Category Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Category Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($category as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/category/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/category/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
