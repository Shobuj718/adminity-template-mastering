...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All Sub Category</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($subcategory as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/subcategory/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/subcategory/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
