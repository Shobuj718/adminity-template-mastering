...
@section('page-title', 'All School Assets List Information ')
...
<div class="card">
	<div class="card-header">
		<h2 style="text-align:center">All School Assets List Information</h2>
			...
			<table id="multi-table" class="table table-striped table-bordered nowrap">
				...
				@foreach($assets as $data)
					...
					<tr>
						...
						<td>
                            <a href="{{url('/assets/'.$data->id.'/edit')}}" class="btn hor-grd btn-grd-success">Edit</a>

                            <a  href="{{url('/assets/delete/'.$data->id)}}" class="btn hor-grd btn-grd-danger">Delete</a>
